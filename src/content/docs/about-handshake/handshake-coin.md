...
* People whose PGP keys are included in the [strong set](https://en.wikipedia.org/wiki/Web_of_trust#Strong_set) (roughly 30,000 keys)
...
```
GET https://learn.namebase.io/about-handshake/handshake-coin.md?ask=<question>
```
